const ptBR = {
  ...
  dashboard: {
    ...
    searchReminders: "Buscar lembretes...",
    upcoming: "Próximos",
    overdue: "Atrasado",
    items: "Itens",
    reminders: "Lembretes",
    sortOverdueFirst: "Atrasados primeiro",
    sortEarliestFirst: "Mais próximos",
    sortLatestFirst: "Mais distantes",
    addTask: "Nova Tarefa",
    addItem: "Novo Item",
    addUrgent: "Novo Urgente",
  },
